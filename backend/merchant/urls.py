...
urlpatterns = [
    ...
    path("update-restaurant-location/", views.update_restaurant_location,
     ...
     path("deliveryman-new-orders/", views.deliveryman_new_orders, name='deliveryman-new-orders'),
     path("deliveryman-current-orders/", views.deliveryman_current_orders, name='deliveryman-current-orders'),
     path("deliveryman-history/", views.deliveryman_history, name='deliveryman-history'),
     path("deliveryman-profile/", views.deliveryman_profile, name='deliveryman-profile'),

...
urlpatterns = [
    ...
    path("forgetpassword/", views.merchant_forgetpassword_view, name='forget_password'),
    path("merchant/reset-password/<uidb64>/<token>/", views.merchant_reset_password_view, name='merchant_reset_password'),
    ...
    path("register-merchant/", views.merchant_form_register_view, name='merchant_register'),
    path("application-status/", views.application_status_view, name="application-status"),
...
=======
    path("update-restaurant-bio/", views.update_restaurant_bio, name="update-restaurant-bio"),

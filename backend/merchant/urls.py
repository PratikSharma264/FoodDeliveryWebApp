...
urlpatterns = [
    ...
    path("registerresturant/", views.merchant_res_reg_view, name='restaurant_register'),
    path("registerdeliveryman/", views.merchant_del_reg_view, name='deliveryman_register'),

...
urlpatterns = [
    ...
    path("update-restaurant-location/", views.update_restaurant_location,
     ...
     path("deliveyman-dashboard/", views.deliveryman_dashboard, name='deliveyman-dashboard'),
     path("deliveyman-new-orders/", views.deliveryman_new_orders, name='deliveyman-new-orders'),
